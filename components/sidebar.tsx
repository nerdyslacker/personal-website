...
import { faEnvelope, faGlobe, faCalendarAlt, faLocationDot, faRssSquare } from '@fortawesome/free-solid-svg-icons';
...
const Sidebar = () => {
  ...
  return (
    <div className="min-h-0 flex-1 flex overflow-hidden">
      <aside className="w-90 fixed h-full border-r border-zinc-800 bg-zinc-950 p-6 overflow-y-auto">
        ...
        <div className="space-y-4">
          <div>
            <h2 className="font-semibold mb-2 text-white">Social</h2>
